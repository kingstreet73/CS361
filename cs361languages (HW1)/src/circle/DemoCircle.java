...
public class DemoCircle {
	...
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		// DONE print c1 with toString
		System.out.println(c1.toString());
		// DONE print c2 with toString
		System.out.println(c2.toString());
		// DONE make a deep copy of c1 with clone and assign it to c3
		
		Circle c3 = (Circle) c1.clone();
		
		
		// DONE write a conditional that checks that c3.equals(c1) is true and print "c3.equals(c1) is true" or "c3.equals(c1) is false" otherwise
		if (c3.equals(c1)) 
