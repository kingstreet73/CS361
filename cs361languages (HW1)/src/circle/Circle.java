...
public class Circle extends GraphicObject implements Cloneable {
	...
	// DONE To complete
	// DONE Be sure that you understand the difference between equals and ==
	/**
	...
	public boolean equals(Object obj) {
		...
		if (this.centerX == c1.centerX && this.centerY == c1.centerY && this.radius == c1.radius) {
			return true;
			}
		return false;
